...
class EmptyCheck extends StatefulWidget {
  ...
  EmptyCheck({Key? key, this.channel,})
      : super(key: key);
  @override
...
Map<String, dynamic>? yolo_result= {
  ...
  'table1': {'chair': {'up': 0, 'down': 0 }, 'object': {"notebook": 0, "book": 0, "bag": 0, "cup": 0}},
  'table2': {'chair': {'up':0, 'down': 0}, 'object': {"notebook": 0, "book": 0, "bag": 0, "cup": 0}},
  'table3': {'chair': {'up': 0, 'down': 0}, 'object': {"notebook": 0, "book": 0, "bag": 0, "cup": 0}}
};
...
class myPainter extends CustomPainter {
  ...
  void table1(Canvas canvas, Size size) {
    if (target == 't1' && yolo_result?["table1"].keys.elementAt(1) == "object") {
  ...
  void table2(Canvas canvas, Size size) {
    if (target == 't2' && yolo_result?["table2"].keys.elementAt(1) == "object") {
  ...
  void table3(Canvas canvas, Size size) {
    if (target == 't3' && yolo_result?["table1"].keys.elementAt(1) == "object") {
